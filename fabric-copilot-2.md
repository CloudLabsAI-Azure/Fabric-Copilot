...
1. Copilot asks permission to add a command cell. Click **Keep** to insert it, then **Allow** to run it automatically, or cancel and run the cell manually.

    ![Notebook screen](images1/df-code-added.png)

1. The code displays the row count result for the query.

    ![](images1/row-count.png)
...
1. If you encounter any issues creating the command with Copilot or see errors in the results, you can use the code below, which was generated by Copilot while testing the functionality. Add the following code to the new cell and then select the **Run cell** button.
    ...
    **Important:** To learn more about Chat-Magics, go to [Overview of chat-magics in Microsoft Fabric notebook](https://learn.microsoft.com/en-us/fabric/data-engineering/copilot-notebooks-overview)
